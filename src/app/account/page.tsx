...
function Account() {
  ...
  return <main className="mx-auto w-full max-w-xl px-5 pb-24 pt-28"><section className="rounded-3xl border border-outline-variant/40 bg-white p-6"><h1 className="text-2xl font-bold">우리 가족 기록 로그인</h1><p className="mt-3 text-sm leading-6 text-on-surface-variant">내 장소·사진·코스를 본인 계정에 안전하게 보관해요. 이메일 링크로 로그인합니다.</p>
